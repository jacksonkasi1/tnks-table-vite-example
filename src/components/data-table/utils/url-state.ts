...
// Custom useSearchParams hook for Vite (non-Next.js)
function useSearchParams(): URLSearchParams | null {
  return null; // Return null to use the fallback implementation with window.location
}
